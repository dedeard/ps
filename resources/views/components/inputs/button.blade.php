...
@php
  $btnClass =
      'group relative inline-block rounded cursor-pointer select-none items-center justify-center py-3 px-4 text-center text-sm font-semibold uppercase leading-none tracking-wider text-white disabled:text-transparent disabled:opacity-70 hover:disabled:cursor-wait';
  if ($variant === 'primary') {
